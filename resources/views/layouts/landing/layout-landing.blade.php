...
<head>
  ...
  <title>{{$title ?? 'project-kkp'}}</title>

  <!-- Favicon-->
  <link rel="icon" type="image/x-icon" href="{{asset('tamplate-landing/assets/favicon.ico') }}" />
  ...
  <link href="{{asset('tamplate-landing/css/styles.css') }}" rel="stylesheet" />
</head>
...
<body id="page-top">
  ...
  <!-- Core theme JS-->
  <script src="{{asset('tamplate-landing/js/scripts.js') }}"></script>
  <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
  <!-- * *                               SB Forms JS                               * *-->
